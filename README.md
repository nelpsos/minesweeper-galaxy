...
|    이름     |                             희귀도                              | 효과                                                                                                                                        | 비고 |
| :---------: | :-------------------------------------------------------------: | :------------------------------------------------------------------------------------------------------------------------------------------ | :--- |
| 추가 우주복 |           우주복 중 무작위 하나를 추가로 얻을 수 있음           | "매 라운드마다 4 이상인 타일을 전부 밝히고 시작함"은 중복될 수 없음                                                                         |
| 우주복 개조 |                   우주복이 2배의 효과를 가짐                    | 패널티도 2배가 됨<br/>"매 라운드마다 4 이상인 타일을 전부 밝히고 시작함"은 강화 시 3 이상으로 변경됨<br/>패널티는 1 이하로 생명을 깎지 않음 |
|    용과     |                            용과 획득                            | 음식                                                                                                                                        |
|   청포도    |                           청포도 획득                           | 음식                                                                                                                                        |
|   두리안    |                           두리안 획득                           | 음식                                                                                                                                        |
|             | 빈 타일을 3번 탐색할 때마다 주변 무작위 지뢰 하나에 깃발을 꽂음 |
|             | 빈 타일을 3번 탐색할 때마다 주변 무작위 숫자 타일 하나를 탐색함 |
...
| 희귀도 |  이름  |                  효과                  |               사용 시기               |
| :----: | :----: | :------------------------------------: | :-----------------------------------: |
|  일반  |  사과  |        수리 도구 목록 새로고침         |    수리 도구 3개 중 하나를 고를 때    |
|  일반  |  마늘  |            외계 동물 무효화            | 라운드 시작 전 외계 동물 목록 공개 시 |
|  일반  | 오렌지 |          선택한 타일 1개 판별          |              라운드 도중              |
|  희귀  |  용과  |          무작위 타일 5개 판별          |              라운드 도중              |
|  희귀  | 청포도 |            모든 2 타일 판별            |              라운드 도중              |
|  희귀  | 두리안 | 생명이 1개 깎이는 대신 모든 빈 칸 탐색 |              라운드 도중              |
